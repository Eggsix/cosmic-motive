...
const initialState = {
  works: [
    ...
    },
    {
      ...
      pageTitle:
        "Actionable analytic data displaying different API issues & information",
      pageSupTitle: "SKETCH DASHBOARD",
      subheroList: [
        {
          title: "Platform",
        ...
        desktop: [
          {
            ...
            background:
              "radial-gradient(circle at 50% 0, #7b8d9a, #1f2a34 79%)",
          },
          {
            type: pageBlockTypes.textWithBg,
            title: "",
            ...
            background:
              "radial-gradient(circle at 50% 5%, #545f88, #060c22 83%)",
          },
          {
            type: pageBlockTypes.textWithBg,
          ...
          },
          {
            ...
            background:
              "url(/img/works/volta/screen-2.png) no-repeat right bottom",
          },
          {
            type: pageBlockTypes.textWithBg,
            title: "",
            ...
            background:
              "url(/img/works/volta/volta-bottom-screen.png) no-repeat right top, linear-gradient(200deg, rgb(29, 60, 97) 0%, rgb(15, 16, 32) 20%)",
          },
          {
            type: pageBlockTypes.textWithBg,
            title: "",
        ...
        mobile: [
          {
            ...
            background:
              "radial-gradient(circle at 50% 0, #7b8d9a, #1f2a34 103%)",
          },
          {
            type: pageBlockTypes.textWithBg,
            title: "",
            ...
            background:
              "radial-gradient(circle at 50% 5%, #545f88, #060c22 88%)",
          },
          {
            type: pageBlockTypes.textWithBg,
            title: "",
          ...
          },
          {
            ...
            background:
              "url(/img/works/volta/screen@2x.png) no-repeat right bottom/contain, linear-gradient(190deg, #1d3c61 76%, #0f1020 100%)",
          },
          {
            type: pageBlockTypes.textWithBg,
            title: "",
          ...
          },
          {
            ...
            background:
              "url(/img/works/volta/volta-new.png) no-repeat center/cover",
          },
          {
            type: pageBlockTypes.textWithBg,
            title: "",
            ...
            background:
              "url(/img/works/volta/volta-charger.png) no-repeat center/cover",
          },
          //
        ],
      },
    },
    {
      ...
      content: {
        desktop: [
          {
            type: pageBlockTypes.iamge,
            title: "",
            imageUrl:
              "/img/works/investors/ibdstockscreener-investors-1@3x.png",
          },
          {
            type: pageBlockTypes.image,
            title: "",
            imageUrl:
              "/img/works/investors/screen-shot-2022-03-21-at-5-59-1@3x.png",
          },
          {
            type: pageBlockTypes.image,
            title: "",
            imageUrl:
              "/img/works/investors/screen-shot-2022-03-23-at-2-44@3x.png",
          },
          {
    ...
    },
    {
      ...
      pageTitle:
        "View Active Inventory & Select Pickup Store for Products Avaliable on Apple.com",
      pageSupTitle: "Apple",
      subheroList: [
        {
          title: "Platform",
    ...
    },
    {
      ...
      pageTitle:
        "Useful statistical data to display different chart types & information",
      pageSupTitle: "SKETCH DASHBOARD",
      subheroList: [
        {
          title: "Platform",
    ...
    },
    {
      ...
      pageTitle:
        "Helping Users Find Their Perfect Home Using Sketch for Ylopo.",
      pageSupTitle: "Desktop & mobile site",
      subheroList: [
        {
          title: "Platform",
      ...
      content: {
        desktop: [
          ...
          },
          {
            ...
            background:
              "linear-gradient(333deg, rgba(0, 0, 0, 0) 56%, #000 100%), linear-gradient(235deg, #100026, #0b3837 41%, #02181c 100%)",
          },
          {
            type: pageBlockTypes.textWithBg,
        ...
        desktop: [
          {
            ...
            background:
              "radial-gradient(circle at 40% 18%, #1e263e, #161d2f 10%, #020203 31%)",
          },
          {
            type: pageBlockTypes.textWithBg,
            title: "Desktop",
    ...
    },
    {
      ...
      pageTitle:
        "Custom Chart Views and Dynamic Layouts Created Exclusively for Sketch.",
        ...
        desktop: [
          {
            ...
            background:
              " radial-gradient(circle at 50% 0%, rgba(17, 26, 42, 0.5), rgba(22, 34, 55, 0.5) 31%, rgba(0, 0, 0, 0.5) 81%), linear-gradient(to bottom, #061221, #061221)",
          },
          {
            type: pageBlockTypes.textWithBg,
          ...
          },
          {
            ...
            background:
              "radial-gradient(circle at 50% 0, rgba(77, 166, 199, 0.5), rgba(0, 0, 0, 0.5) 78%), linear-gradient(to bottom, #061221, #061221)",
          },
          {
            type: pageBlockTypes.textWithBg,
            title: "",
            ...
            background:
              "linear-gradient(to bottom, rgba(0, 0, 0, 0.32), rgba(0, 0, 0, 0.32)), linear-gradient(122deg, #0b1c3d, #143b4e 55%, #032611 98%)",
          },
          {
            type: pageBlockTypes.textWithBg,
            title: "",
            ...
            background:
              "radial-gradient(circle at 50% 0, rgba(134, 35, 227, 0.5), rgba(0, 0, 0, 0.5) 78%), linear-gradient(to bottom, #061221, #061221)",
          },
          {
            type: pageBlockTypes.avaliableOn,
            title: "Avaliable on",
      ...
      content: {
        desktop: [
          ...
          },
          {
            ...
            imageUrl:
              "/img/works/react-dashboard/mission-control-budget-launch.png",
            background: "#070e19",
          },
          {
            type: pageBlockTypes.textWithBg,
            title: "",
            imageUrl:
              "/img/works/react-dashboard/mission-control-lead-no-circles.jpg",
            background: "#070e19",
          },
          {
            type: pageBlockTypes.textWithBg,
            title: "",
            imageUrl:
              "/img/works/react-dashboard/mission-control-location-active.png",
            background: "#070e19",
          },
          {
            type: pageBlockTypes.textWithBg,
          ...
          },
          {
            ...
            title: "",
            imageUrl:
              "/img/works/react-dashboard/edit-domain-search-active.png",
            background: "#070e19",
          },
          {
            type: pageBlockTypes.textWithBg,
          ...
          },
          {
            ...
            imageUrl:
              "/img/works/react-dashboard/mission-control-success-notify-all.png",
            background: "#070e19",
          },
          {
            type: pageBlockTypes.textWithBg,
    ...
    },
    {
      title: "Sci-Fi",
      description:
        "Craft Memorable and Futuristic Product Concepts Using Sketch.",
      ...
      content: {
        desktop: [
          ...
          },
          {
            ...
            background:
              'url("/img/works/ski-fi/screen@3x.png") no-repeat center/cover, #141a24',
          },
          {
            type: pageBlockTypes.avaliableOn,
            title: "Avaliable on",
        ...
        desktop: [
          {
            ...
            background:
              "radial-gradient(circle at 50% -15%, #727c99, #323643 10%, #131417 80%)",
          },
          {
            type: pageBlockTypes.textWithBg,
            title: "File Logic",
          ...
          },
          {
            ...
            background:
              "radial-gradient(circle at 40% 18%, #222631, #1c1f29 10%, #121419 31%)",
          },

          {
            ...
            background:
              "radial-gradient(circle at 40% 18%, #222631, #222633 10%, #121419 31%)",
          },
          {
            type: pageBlockTypes.textWithBg,
            title: "Tablet 570px",
    ...
    },
    {
      ...
      pageTitle:
        "Futuristic Chat Product Concept for Displaying Various Text Information.",
    ...
    },
    {
      ...
      pageTitle:
        "A Collection of Printed Media Crafted for Trion Worlds and Other Concept Designs.",
      ...
      content: {
        desktop: [
          {
            ...
            background:
              'url("/img/works/sci-fi-2023/sci-fi-2023-background-1.png") no-repeat right center/contain, linear-gradient(193deg, #051024 93%, rgba(6, 17, 38, 0) 69%, #051024 24%)',
          },
          {
            type: pageBlockTypes.textWithBg,
            title: "",
          ...
          },
          {
            ...
            background:
              'url("/img/works/sci-fi-2023/sci-fi-2023-background-2.png") no-repeat right center/contain, linear-gradient(193deg, #051024 92%, rgba(6, 17, 38, 0.54) 48%, #051024 -3%)',
          },
          {
            type: pageBlockTypes.textWithBg,
            title: "",
            ...
            background:
              'url("/img/works/sci-fi-2023/background-test.png") no-repeat left top, #051028',
          },
          {
            type: pageBlockTypes.textWithBg,
            fullwidth: true,
        ...
        mobile: [
          ...
          },
          {
            ...
            background:
              "linear-gradient(188deg, #051024 94%, rgba(6, 17, 38, 0) 67%, #051024 17%)",
          },
          {
            type: pageBlockTypes.textWithBg,
            title: "",
            ...
            background:
              'url("/img/works/sci-fi-2023/sci-fi-2023-background-1.png") no-repeat center right, linear-gradient(188deg, #051024 94%, rgba(6, 17, 38, 0) 67%, #051024 17%)',
          },
          {
            type: pageBlockTypes.textWithBg,
            title: "",
          ...
          },
          {
            ...
            background:
              'url("/img/works/sci-fi-2023/sci-fi-2023-mobile-background-1.png") no-repeat center/cover, linear-gradient(188deg, #051024 94%, rgba(6, 17, 38, 0) 67%, #051024 17%)',
          },
          {
            type: pageBlockTypes.textWithBg,
            title: "",
